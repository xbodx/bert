...
class BertModel(object):
  ...
  def __init__(self,
    ...
    if isinstance(is_training, bool):
      ...
      hidden_dropout_prob = tf.cond(pred=is_training, true_fn=lambda: config.hidden_dropout_prob, false_fn=lambda: 0.0)
      attention_probs_dropout_prob = tf.cond(pred=is_training, true_fn=lambda: config.attention_probs_dropout_prob, false_fn=lambda: 0.0)
